...
# limpeza dos dados de pesticidas
pesticidas_data = pesticidas.preprocessamento_pesticidas(path_brutos)
pesticidas_data.to_csv(os.path.join(path_limpos, 'pesticidas_total.csv'))
