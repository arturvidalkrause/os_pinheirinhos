"""Módulo de teste para o a função de limpeza do dataset de fertilizantes"""
...
class TestPreprocessamentoFertilizantes(unittest.TestCase):
    ...
    def create_temp_csv(self, content):
        ...
        temp_path = 'test_temp_fertilizantes.csv'
...
Brazil,5157,1234,Total Nutrient Use,t,200,210,220
World,5157,1234,Total Nutrient Use,t,300,310,320
World,5157,1234,Total Nutrient Use,t,400,410,420"""
        
        temp_path = self.create_temp_csv(csv_content)
        cleaned_data = preprocessamento_fertilizantes(temp_path)
        os.remove(temp_path)
